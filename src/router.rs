...
use crate::token_validator::{BearerTokenValidator, TokenValidator};
...
impl Router {
    ...
    pub fn find_route_and_validate(
        &self,
        path: &str,
        ...
        Err(ProxyError::RouteError(format!(
...
mod tests {
    use super::*;
    use crate::config::{
        default_strip_headers, Config, LoggingConfig, ServerConfig, TokenValidationConfig,
    };
